  ...
  return (
    <div className="animate-fade-in max-w-2xl mx-auto space-y-6 pb-12">
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <h2 className="text-2xl font-bold text-slate-800">Novo Departamento</h2>
        <p className="text-slate-500 text-sm mt-1">Cadastre um novo departamento e vincule-o a uma unidade</p>
      </div>
