...
import { useCreateDepartamento } from '../hooks/useDepartamentos';
...
export default function DepartamentoForm() {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    create.mutate(
      { nome, sigla, unidade_academica: Number(unidadeAcademica) },
  ...
  return (
    <div className="max-w-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Unidade Acadêmica *</label>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button type="button" onClick={() => navigate('/departamentos')} className="px-6 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">
            Cancelar
          </button>
        </div>
