...
export default function UnidadeForm() {
  ...
  return (
    <div className="max-w-lg">
      <h2 className="text-2xl font-bold mb-6">Nova Unidade Acadêmica</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button type="button" onClick={() => navigate('/unidades')} className="px-6 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">
            Cancelar
          </button>
        </div>
